...
<!DOCTYPE HTML><html><head>
  ...
  <body>
   ...
   <span class="auto-style3"><strong>ESP32-Fibonacci Clock</strong></td>
     </tr>
     <tr>
   ...
   <span class="auto-style1">
    <strong>O</strong> Display <span class="auto-style4">On/Off</span><br class="auto-style4">
     ...
     <tr>
       <td colspan="3">
   <span class="auto-style1">
    <strong>Q</strong> Display colour choice <span class="auto-style4">(Q0-Q9)</span></td>
     </tr>
     <tr>
       <td style="width: 108px">
   <span class="auto-style1">
    <strong>  Q0</strong> Mondriaan1</td>
       <td style="width: 98px">
   <span class="auto-style1">    <strong>Q1</strong> Hourly</td>
       <td style="width: 125px">
   <span class="auto-style1">
    <strong>  Q2</strong> Mondriaan1</td>
     </tr>
     <tr>
       <td style="width: 108px">
   <span class="auto-style1"> <strong>Q3</strong> RGB Own</td>
       <td style="width: 98px">
   <span class="auto-style1">
    <strong>  Q4</strong> Greens</td>
       <td style="width: 125px">
   <span class="auto-style1"> <strong>Q5</strong> Modern</td>
     </tr>
     <tr>
       <td style="width: 108px">
   <span class="auto-style1">
    <strong>  Q6</strong> Cold </td>
       <td style="width: 98px">
   <span class="auto-style1">
    <strong>  Q7</strong> Warm</td>
       <td style="width: 125px">
   <span class="auto-style1">
       <strong>Q8</strong> Earth</td>
     </tr>
     <tr>
       <td colspan="2">
   <span class="auto-style1">
